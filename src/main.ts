  ...
  <div class="min-h-screen bg-gray-50 flex flex-col font-sans">
    <main class="flex-grow container mx-auto px-4 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <!-- Placeholder: Tank 1990 -->
        <div class="block bg-white rounded-xl shadow-md overflow-hidden opacity-75 cursor-not-allowed">
          <div class="relative pb-[56.25%] bg-gray-200">
            <div class="absolute inset-0 flex items-center justify-center bg-green-900 text-white">
              <span class="text-3xl font-bold">Coming Soon</span>
            </div>
          </div>
          <div class="p-6">
            <h3 class="text-2xl font-bold text-gray-400 mb-2">Tank 1990</h3>
            <p class="text-gray-500">Defend your base and destroy enemy tanks. Currently in development.</p>
          </div>
        </div>
